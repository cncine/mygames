function main() {
    ...
    this.bgmRemote = true; // 是否采用远程BGM
    this.bgmRemoteRoot = "https://xuesenchan.gitee.io/cloud-media/file/"; // 远程BGM的根目录
...
main.dom.playGame.onclick = function () {
    if (!confirm("开始新游戏将会覆盖你的存档，将会从头开始，你确定吗？欲继续请点击载入游戏。")) return;
